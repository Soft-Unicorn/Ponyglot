...
public class AssemblyCatalogSource : StreamCatalogSource
{
        ...
        : base(catalogReader)
    {
        ...
        _defaultDomain = assembly.GetName().Name ?? "";
...
#pragma warning restore CS1998
    {
        foreach (var resourceName in Assembly.GetManifestResourceNames())
        {
            ...
            if (Options.Filter == null || Options.Filter(Assembly, resourceName))
            {
                ...
                var domain = Options.DomainResolver?.Invoke(Assembly, resourceName) ?? _defaultDomain;
                yield return new Resource(Assembly, uid, resourceName, domain);
            }
        }
    }

    /// <summary>
    /// The <see cref="StreamResource"/> that represents an embedded resource.
    /// </summary>
    private class Resource : StreamResource
    {
        ...
        /// <inheritdoc/>
        public Resource(Assembly assembly, string uid, string name, string domain)
