...
public class CatalogTest
{
    ...
    public void Constructor_ValidArguments_SetsTheProperties()
    {
        ...
        // Assert
        sut.Uri.Should().BeSameAs(_uri);
        sut.Domain.Should().Be(_domain);
    ...
    public void Constructor_ArgumentIsNull_Throws(string parameterName)
    {
        ...
        var action = () => new Catalog(
            parameterName == "uri" ? null! : _uri,
            parameterName == "domain" ? null! : _domain,
    ...
    public void Constructor_DuplicateEntryForMessageAndContext_Throws()
    {
        ...
        action.Should().ThrowExactly<ArgumentException>()
            ...
            .WithMessage("Duplicate catalog entry for message 'my-message' with context 'my-context' in catalog 'my:catalog'.*");
    }
    ...
    public void Constructor_EntryHasNoTranslations_Throws()
    {
        ...
        action.Should().ThrowExactly<ArgumentException>()
            .WithParameterName("entries")
            .WithMessage("No translations defined for message 'my-message' with context 'my-context' in catalog 'my:catalog'.*");
    }
    ...
    public void Constructor_PluralEntryHasInvalidPluralCount_Throws()
    {
        ...
        action.Should().ThrowExactly<ArgumentException>()
            .WithParameterName("entries")
            .WithMessage("Plurals count (2) mismatch for message 'my-message' with context 'my-context' in catalog 'my:catalog' (expected 3).*");
    }
    ...
    public void Constructor_CompositeFormatFormHasInvalidFormatString_Throws()
    {
        ...
        action.Should().ThrowExactly<ArgumentException>()
            .WithParameterName("entries")
            .WithMessage($"Invalid translation format string ({{0 BAD) at index 0 for message 'my-message' with context 'my-context' in catalog 'my:catalog': {formatError}*");
    }
    ...
    public void ToString_Created_ReturnsTheUri()
    {
        ...
        // Assert
        result.Should().Be(_uri.ToString());
    }
    ...
    private Catalog CreateSut(IEnumerable<MessageEntry>? entries = null)
    {
        ...
        return new Catalog(_uri, _domain, _culture, _pluralRule, entries);
    }
