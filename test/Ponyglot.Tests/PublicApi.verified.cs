...
namespace Ponyglot
{
    ...
    {
        public Catalog(string uid, string domain, System.Globalization.CultureInfo culture, Ponyglot.IPluralRule pluralRule, System.Collections.Generic.IEnumerable<Ponyglot.MessageEntry> entries) { }
...
namespace Ponyglot.Sources
{
    ...
    public class AssemblyCatalogSourceOptions
    {
        ...
        public System.Func<System.Reflection.Assembly, string, string>? DomainResolver { get; set; }
    ...
    public class FileSystemCatalogSourceOptions
    {
        ...
        public System.Func<System.IO.FileInfo, string>? DomainResolver { get; set; }
    ...
    public class HttpCatalogSourceOptions
    {
        ...
        public System.Func<System.Uri, string>? DomainResolver { get; set; }
    ...
    {
        protected StreamResource(string uid, string name, string domain) { }
        public string Domain { get; }
