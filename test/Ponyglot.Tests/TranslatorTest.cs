...
public class TranslatorTest
{
    ...
    public TranslatorTest()
    {
        ...
        _translationStore.ReturnsForAll("my-default-translation");
    ...
    public void ForCulture_NoState_ReturnsAnInstanceLockedOnTheSpecifiedCulture(
        [CombinatorialValues(null, "", "my-domain")] string? context,
    ...
    public void T_Always_QueryTheStoreForTheTranslation(string? context)
    {
        ...
        // Assert
        _translationStore.ReceivedWithAnyArgs(1).Find(default!, default!, default, default!);
        _translationStore.Received(1).Find("my-domain", _cultureSource.Culture, context, "my-message");
    }
    ...
    public void T_MessageFoundAndIsNotAFormatString_ReturnsMessage(string argsCase)
    {
        ...
        _translationStore.Find(default!, default!, default, default!).ReturnsForAnyArgs("my-translated-message");
    ...
    public void T_MessageFoundAndIsAFormatString_ReturnsFormattedMessage(bool originalMessageWasAFormatString)
    {
        ...
        _translationStore.Find(default!, default!, default, default!).ReturnsForAnyArgs("my-translated-message-{0:N0}");
    ...
    public void T_MessageNotFoundAndIsNotAFormatString_ReturnsMessage(string argsCase)
    {
        ...
        _translationStore.Find(default!, default!, default, default!).ReturnsForAnyArgs((string?)null);
    ...
    public void T_MessageHasAndAdditionalArguments_ReturnsFormattedMessage(string messageId, string? translation)
    {
        // Arrange
        var sut = CreateSut();
        _translationStore.Find(default!, default!, default, default!).ReturnsForAnyArgs(translation);
    ...
    public void T_MessageStoreThrows_Throws()
    {
        ...
        _translationStore.Find(default!, default!, default, default!).ThrowsForAnyArgs(storeError);
    ...
    public void N_Always_QueryTheStoreForTheTranslation(string? context)
    {
        ...
        // Assert
        _translationStore.ReceivedWithAnyArgs(1).FindPlural(default!, default!, default, default, default!, default!);
        _translationStore.Received(1).FindPlural("my-domain", _cultureSource.Culture, context, 123, "my-message", "my-plural");
    }
    ...
    public void N_MessageFoundAndIsNotAFormatString_ReturnsMessage(string argsCase)
    {
        ...
        _translationStore.FindPlural(default!, default!, default, default, default!, default!).ReturnsForAnyArgs("my-translated-message");
    ...
    public void N_MessageFoundAndIsAFormatString_ReturnsFormattedMessage(bool originalMessageWasAFormatString)
    {
        ...
        _translationStore.FindPlural(default!, default!, default, default, default!, default!).ReturnsForAnyArgs("my-translated-message-{0:N0}");
    ...
    public void N_MessageNotFoundAndIsNotAFormatString_ReturnsMessage(string argsCase)
    {
        ...
        _translationStore.FindPlural(default!, default!, default, default, default!, default!).ReturnsForAnyArgs((string?)null);
    ...
    public void N_MessageHasAndAdditionalArguments_ReturnsFormattedMessage(string messageId, string? translation)
    {
        // Arrange
        var sut = CreateSut();
        _translationStore.FindPlural(default!, default!, default, default, default!, default!).ReturnsForAnyArgs(translation);
    ...
    public void N_MessageStoreThrows_Throws()
    {
        ...
        var storeError = new Exception("💥Kaboom💥");
        _translationStore.FindPlural(default!, default!, default, default, default!, default!).ThrowsForAnyArgs(storeError);
    ...
    private Translator CreateSut(string domain = "<domain>", string? context = null) => new Translator(_translationStore, _cultureSource, domain, context);
