...
public class TranslatorTest
{
    ...
    public TranslatorTest()
    {
        ...
        _sut = Substitute.ForPartsOf<TranslatorDouble>(_translationStore, _cultureSource, "my-domain", "my-context");
    }
    ...
    public void Context_Created_ReturnsTheConstructorValue()
    {
        ...
        // Act
        var domain = _sut.Context;

        // Assert
        domain.Should().Be("my-context");
    }
    ...
    public void ForCulture_NoState_ReturnsAnInstanceLockedOnTheSpecifiedCulture(string cultureName)
    {
        ...
        result.Should().BeOfType<Translator>().Which.Should().Satisfy<Translator>(o =>
        {
            ...
            o.Domain.Should().Be(_sut.Domain);
    ...
    public void GetTranslation_Always_SearchesForTheTranslation()
    {
        ...
        // Assert
        _translationStore.Received(1).TryGet(_sut.Domain, _cultureSource.Culture, _sut.Context, 123, "my-message-id", out _);
    }
    ...
    {
        public TranslatorDouble(TranslationStore translationStore, ICultureSource cultureSource, string domain, string context)
            : base(translationStore, cultureSource, domain, context)
        {
        }
