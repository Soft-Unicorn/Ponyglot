...
public class HttpCatalogJsonManifestReaderTest
{
    private readonly HttpCatalogJsonManifestReader _sut = new();
    ...
    public void MediaTypes_Created_ReturnsExpectedMediaTypes()
    {
        ...
        // Assert
        mediaTypes.Should().BeEquivalentTo("application/json");
    }
    ...
    [Fact]
    public async Task ReadAsync_JsonHasComments_Throws()
    {
        // Arrange
        var stream = new MemoryStream("""
            [
    ...
    [Fact]
    public async Task ReadAsync_JsonIsInvalid_Throws()
    {
        // Arrange
        var stream = new MemoryStream("""
            [
