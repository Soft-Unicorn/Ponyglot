...
public class TranslationStoreTest
{
    ...
    {
        // Arrange
        var catalog1 = new TestCatalog("my-domain", "qps-Ploc", "my-catalog-1");
        var catalog2 = new TestCatalog("my-domain", "qps-Ploc", "my-catalog-2");
        ...
        action.Should().ThrowExactly<ArgumentException>()
            ...
            .WithMessage("The list of catalogs contains more than one catalog for domain 'my-domain' and culture 'qps-Ploc': 'my-catalog-1' and 'my-catalog-2'.*");
    }
    ...
    public void Initialize_CatalogsContainsANullItem_ValidationFails()
    {
        ...
        var catalogs = new[]
        {
            new TestCatalog("my-domain-1", "qps-Ploc", "my-catalog-1"),
            new TestCatalog("my-domain-2", "qps-Ploc", "my-catalog-2"),
            new TestCatalog("my-domain-3", "qps-Ploc", "my-catalog-2"),
            new TestCatalog("my-domain-4", "qps-Ploc", "my-catalog-2"),
            new TestCatalog("my-domain-5", "qps-Ploc", "my-catalog-2"),
            null!,
            new TestCatalog("my-domain-6", "qps-Ploc", "my-catalog-2"),
        };
    ...
    internal class TestCatalog : Catalog
    {
        ...
        public TestCatalog(string? domain = null, string? cultureName = null, string? uid = null)
        {
